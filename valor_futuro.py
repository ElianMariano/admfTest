...
class FutureValue:
    def __init__(self, driver_path = "..", application_path="https://administracao-financeira.vercel.app/valor-futuro"):
        ...
        # Encontra os inputs
        self.valor_futuro = self.driver.find_element_by_id("valor_presente")
        self.taxa = self.driver.find_element_by_id("taxa")
        self.periodos = self.driver.find_element_by_id("periodos")
